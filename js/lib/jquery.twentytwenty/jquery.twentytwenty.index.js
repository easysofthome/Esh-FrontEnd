...
(function($){
  ...
  $.fn.twentytwenty = function(options) {
    ...
    // slider.append(appendHtml);
      ...
      /* 自定义修改部分 */
      var quarterW = (0.185) * $(window).width();
     // alert( $(window).width());
      //quarterW = 244;
      $('.twentytwenty-before').css('left',0);
      $('.twentytwenty-after').css('left',0);
      /* 自定义修改部分 */
      ...
      var adjustContainer = function(offset) {
          ...
          beforeImg.css("clip", "rect(0,"+(parseInt(offset.cw))+"px" +","+offset.h+","+0+"px"+")");
    	}
