            ...
            $('#yarn-ul').append('<li class="lf yarn_para">'
                ...
                + '<div class="lf" style="width: 142px;">'
                  + '<span class="clearfix ingredient" >'
                    ...
                    + '<input dataName="FactoryYarnId" name="FabricYarnsChaine['+ warpNum +'].IsChaineDensity" type="hidden" value="true">'
                    + '<input dataName="IsChaineDensity" name="FabricYarnsChaine['+ warpNum +'].FactoryYarnId" type="hidden" value="">'
                  + '</span>'
              ...
              + '<div class="lf" style="width: 142px;">'
                + '<span class="clearfix ingredient">'
                  ...
                  + '<input dataName="FabricElementId" name="FabricYarns['+ abbNum +'].FabricElementId" type="hidden" value="">'
                    ...
                    + '<input dataName="FactoryYarnId" name="FabricYarns['+ abbNum +'].IsChaineDensity" type="hidden" value="false">'
                    + '<input dataName="IsChaineDensity" name="FabricYarns['+ abbNum +'].FactoryYarnId" type="hidden" value="">'
                + '</span>'
                + '<span class="clearfix thickness">'
                  + '<span class="lf ingredient_tit">粗细</span>'
